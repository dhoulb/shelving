...
type AnyReference = AsyncItem<any, any> | AsyncQuery<any, any>; // eslint-disable-line @typescript-eslint/no-explicit-any
...
function _getReferenceState<T extends Datas, K extends DataKey<T>>(ref: Reference<T, K> | undefined, cache: Map<string, ReferenceState<T, K>>): ReferenceState<T, K> | undefined {
