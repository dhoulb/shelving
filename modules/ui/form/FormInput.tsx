...
/**
 * Props for `FormInput`, a bare [`SchemaInput`](/ui/SchemaInput) bound to a named form field.
 *
...
/**
 * Show a [`SchemaInput`](/ui/SchemaInput) for a single named property of the current form.
