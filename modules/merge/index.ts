 ...
 */
export function deepMergeObject<L extends ImmutableObject, R extends ImmutableObject>(left: L, right: R): L & R;
export function deepMergeObject(left: ImmutableObject, right: ImmutableObject): ImmutableObject {
	if (left === right) return right;
