...
export function mapArray<I, O, A extends Arguments = []>(
	...
	...args: A
): ImmutableArray<O>; // Helps `I` and `O` carry through functions that use generics.
...
export function mapObject<I extends ImmutableObject, O extends ImmutableObject, A extends Arguments = []>(
	obj: I,
	transform: (v: Value<I>, ...args: A) => Value<O>,
	...args: A
): O; // Helps `I` and `O` carry through functions that use generics.
export function mapObject<I extends ImmutableObject, O extends ImmutableObject, A extends Arguments = []>(
	obj: I,
	transform: Transform<Value<I>, Value<O>, A>,
	...args: A
): O;
export function mapObject<I extends ImmutableObject, O extends ImmutableObject, A extends Arguments = []>(
	obj: I,
	transform: Transform<Value<I>, Value<I>, A>,
	...args: A
): O {
...
export function mapSequence<I, O, A extends Arguments = []>(
...
export function mapSequence<I, O, A extends Arguments = []>(
	sequence: AsyncIterable<I>,
	transform: AsyncTransform<I, O, A>,
	...args: A
): AsyncIterable<O>;
