import { isEqual, isDeepEqual, isArrayEqual, isObjectEqual, isObjectMatch } from "../index.js";
...
test("isObjectMatch(): Equal values", () => {
	expect(isObjectMatch(objFlat, objFlat)).toBe(true);
	expect(isObjectMatch(objFlat, objFlatSame)).toBe(true);
	expect(isObjectMatch(objFlat, objFlat)).toBe(true);
	expect(isObjectMatch(objFlat, objFlatSame)).toBe(true);
	expect(isObjectMatch(objDeep, objDeep)).toBe(true);
	expect(isObjectMatch(objFlatEmpty, {})).toBe(true);
	expect(isObjectMatch({}, objFlatEmpty)).toBe(true);
	expect(isObjectMatch(objDeep, objDeep, isDeepEqual)).toBe(true);
	expect(isObjectMatch(objDeep, objDeepSame, isDeepEqual)).toBe(true);
	expect(isObjectMatch(objDeepSame, objDeep, isDeepEqual)).toBe(true);
});
test("isObjectMatch(): Matching values", () => {
	expect(isObjectMatch(objFlat, objFlatMissing)).toBe(true);
});
