...
test("hydrate(): Works correctly with class instances", () => {
	...
	expect((original2 as any).details.invalid).not.toBe((hydrated2 as any).details.invalid);
	expect((original2 as any).details.invalid).toEqual((hydrated2 as any).details.invalid);
	expect((original2 as any).details.success).not.toBe((hydrated2 as any).details.success);
	expect((original2 as any).details.success).toEqual((hydrated2 as any).details.success);
});
test("hydrate(): Works correctly with arrays of objects", () => {
	...
	const dehydrated2 = dehydrate(original2, HYDRATIONS);
	const hydrated2 = hydrate(dehydrated2, HYDRATIONS);
	expect((hydrated2 as any)[1]).toBeInstanceOf(SuccessFeedback);
	expect(original2).not.toBe(hydrated2);
	expect(original2).toEqual(hydrated2);
	expect((original2 as any)[1].details.invalid).not.toBe((hydrated2 as any)[1].details.invalid);
	expect((original2 as any)[1].details.invalid).toEqual((hydrated2 as any)[1].details.invalid);
	expect((original2 as any)[1].details.success).not.toBe((hydrated2 as any)[1].details.success);
	expect((original2 as any)[1].details.success).toEqual((hydrated2 as any)[1].details.success);
...
test("hydrate(): Works correctly with plain objects of objects", () => {
	...
	const hydrated2 = hydrate(dehydrated2, HYDRATIONS);
	expect((hydrated2 as any).obj).toBeInstanceOf(SuccessFeedback);
	expect(original2).not.toBe(hydrated2);
	expect(original2).toEqual(hydrated2);
	expect((original2 as any).obj.details.invalid).toEqual((hydrated2 as any).obj.details.invalid);
	expect((original2 as any).obj.details.invalid).not.toBe((hydrated2 as any).obj.details.invalid);
	expect((original2 as any).obj.details.success).toEqual((hydrated2 as any).obj.details.success);
	expect((original2 as any).obj.details.success).not.toBe((hydrated2 as any).obj.details.success);
