import { Validator, Validatable, GET_UNDEFINED, validate } from "../util/index.js";
...
export function RESOURCE(payload: Validator<unknown> = GET_UNDEFINED, result: Validator<unknown> = GET_UNDEFINED): Resource<unknown, unknown> {
