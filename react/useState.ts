...
import { Dependencies, UnknownFunction, UnsubscribeDispatcher, isArrayEqual, State, createState, NOVALUE } from "shelving/tools";
...
export function useState<T>(input: Exclude<T, UnknownFunction>, deps?: Dependencies): State<T>; // Detect plain values (dependencies are optional).
