...
import { DeepPartial, isObject, MutableObject, ReadonlyObject } from "./object";
 ...
 */
export function deepDiff<R extends ReadonlyObject>(left: unknown, right: R): R | DeepPartial<R> | typeof EQUAL;
export function deepDiff<R extends unknown>(left: unknown, right: R): R | typeof EQUAL;
export function deepDiff(left: unknown, right: DeepPartial<ReadonlyObject> | unknown): DeepPartial<ReadonlyObject> | unknown | typeof EQUAL {
 ...
 */
export function deepDiffObject<R extends ReadonlyObject>(left: ReadonlyObject, right: R): R | DeepPartial<R> | typeof EQUAL;
export function deepDiffObject(left: ReadonlyObject, right: ReadonlyObject): ReadonlyObject | typeof EQUAL {
	if (left === right) return EQUAL;
