import { object, array, string, number, date, data } from "shelving/schema";
import { Provider, Database, createDatabase } from "shelving/db";
import { mapObject } from "shelving/tools";
import type { EmptyObject } from "shelving/tools";
...
export const createTestDatabase = <P extends Provider>(provider: P): Database<EmptyObject, typeof collections, P> => createDatabase({ collections, provider });
